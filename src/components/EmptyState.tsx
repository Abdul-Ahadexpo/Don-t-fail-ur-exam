      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 text-center opacity-75">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Import Questions</h3>
            <p className="text-gray-400">Upload question sets from others (add questions first)</p>
          </div>
        </div>
